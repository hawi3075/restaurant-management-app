...
export default function KitchenDashboardScreen({ route, navigation }) {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Note: Because AuthContext handles user state changes globally,
      // wiping AsyncStorage will automatically trigger a state update in App.js 
      // and redirect the user back to the Login screen naturally.
    } catch (error) {
